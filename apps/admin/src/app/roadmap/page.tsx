...
const phases: Phase[] = [
  {
    ...
    milestones: [
      ...
      { label: "Interview & presentation templates", status: "done" },
      { label: "Real-time voice input (STT)", status: "active" },
      { label: "Scoring & feedback system", status: "done" },
      { label: "Session replay & coaching insights", status: "done" },
      { label: "Education templates — history, debate, oral exams", status: "upcoming" },
      { label: "Consumer-facing world builder (node-based)", status: "upcoming" },
      { label: "Institutional onboarding & multi-seat (schools, orgs)", status: "upcoming" },
    ],
  },
  {
    id: "wellness-stories",
    ...
    description:
      "Extend the world engine into meditative, therapeutic, narrative, and educational spaces. Guided meditations, self-exploration journeys, branching stories, and curriculum-driven worlds where students learn history, science, and civics by living inside the subject matter.",
    color: "#c4a7e7",
    ...
    milestones: [
      ...
      { label: "Classroom worlds — history simulations, Socratic dialogue", status: "upcoming" },
      { label: "Educator dashboard & curriculum alignment tools", status: "upcoming" },
  ...
  },
  {
    ...
    milestones: [
      ...
      { label: "Visual classroom environments & interactive timelines", status: "upcoming" },
